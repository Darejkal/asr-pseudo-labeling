...
def extract_entities(text: str,mode="offline",tokenizer=None,model=None) -> List[Dict[str, Any]]:
    ...
    prompt = (
        "You are an expert NLP entity extraction system for Vietnamese ASR (speech-to-text) transcripts.\n"
        "The input is a timestamped conversation transcript. Extract entities and indicate which line/timestamp they appear in.\n"
        "Note: The text may contain phonetic typos (e.g., 'hát' for letter 'H', 'bê tê xê' or 'vê tê xê' might be for 'VETC'). Interpret context intelligently.\n\n"
        "### Entity Types & Definitions:\n"
        "1. name: Person's name. Can be a full name OR a specific first name if clearly addressed (e.g., 'Thắng', 'Quyết').\n"
        "2. id_number: Identification codes. Includes: Tax IDs (mã số thuế), License Plates (biển số xe), Account IDs, or Citizen IDs.\n"
        "3. organization: Company names, businesses, or institutions (e.g., 'Công ty Đian Cô', 'Ngân hàng ABC').\n"
        "4. location: Specific addresses, cities, districts, or landmarks.\n\n"
        "### CRITICAL CONSTRAINTS:\n"
        "- **NO PRONOUNS:** Do NOT extract 'anh', 'chị', 'em' as names. Only extract the specific name (e.g., from 'anh Thắng', extract 'Thắng').\n"
        "- **NO FILLERS:** Ignore 'ạ', 'vâng', 'nhé', 'alo'.\n"
        "- **FORMAT:** Return a valid JSON array. Each entity must have 'type', 'value' (exact text substring), and 'timestamp' (the full timestamp key).\n"
        "- **EMPTY:** If no entities are found, return [].\n\n"
        "### Examples:\n"
        "Input:\n"
        "[00:00:01.04 - 00:00:02.31] SPEAKER_00: tôi tên là hùng\n"
        "[00:00:03.50 - 00:00:05.20] SPEAKER_00: mã số thuế là không một hai ba\n"
        "Output:\n"
        "[{\"type\": \"name\", \"value\": \"hùng\", \"timestamp\": \"[00:00:01.04 - 00:00:02.31]\"}, "
        "{\"type\": \"id_number\", \"value\": \"không một hai ba\", \"timestamp\": \"[00:00:03.50 - 00:00:05.20]\"}\n\n"
        "Input:\n"
        "[00:01:10.00 - 00:01:12.00] SPEAKER_01: dạ vâng ạ em nghe\n"
        "[00:01:12.50 - 00:01:16.00] SPEAKER_01: xe này thuộc công ty vận tải biển đông biển số ba mươi hát chín chín tám tám\n"
        "[00:01:17.00 - 00:01:19.00] SPEAKER_00: tài xế là anh đức đúng không em đang ở đà nẵng\n"
        "Output:\n"
        "[\n"
        "  {\"type\": \"organization\", \"value\": \"công ty vận tải biển đông\", \"timestamp\": \"[00:01:12.50 - 00:01:16.00]\"},\n"
        "  {\"type\": \"id_number\", \"value\": \"ba mươi hát chín chín tám tám\", \"timestamp\": \"[00:01:12.50 - 00:01:16.00]\"},\n"
        "  {\"type\": \"name\", \"value\": \"đức\", \"timestamp\": \"[00:01:17.00 - 00:01:19.00]\"},\n"
        "  {\"type\": \"location\", \"value\": \"đà nẵng\", \"timestamp\": \"[00:01:17.00 - 00:01:19.00]\"}\n"
        "]\n\n"
        f"### Input Text:\n{text}\n\n"
        "### Output JSON:"
    )
